...
public class Screen_Help2  extends Screen {
	
	public Screen_Help2(IGame game, Activity activity) {
		super(game, activity);
	}
	...
	public void present(float deltaTime) {
		...
		g.drawPixmap(Assets.img_help2, 0, 0);
	}
	...
	public boolean onBackPress_II() {
		this.m_Game.setScreen(new Screen_Help1(this.m_Game, this.m_Activity));
		return false;
	}
}
